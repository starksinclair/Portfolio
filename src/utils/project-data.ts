...
interface Work {
    ...
    category: "FRONTEND DEVELOPMENT" | "BACKEND DEVELOPMENT" | "OTHER TECHNOLOGIES" | "FULL STACK DEVELOPMENT";
  }

export const works: Work[] = [
    { id: "eng104", title: "ENG104 MONSTER", thumbnail: Eng104,  description:
      ...
      link: "/works/eng104", category: "FRONTEND DEVELOPMENT" }, 
    { id: "corpstube", title: "Corpstube", thumbnail: Corptube, description:
      "Train Smarter with CORPTUBE: This custom video streaming platform, designed for Ball State University's Digital Corps, streamlines training content and optimizes the learning experience. (Responsive web design)",
       link: "/works/corpstube", category: "FRONTEND DEVELOPMENT" },
    { id: "saintly", title: "Saintly", thumbnail: Saintly, description:
      ...
      link: "/works/saintly", category: "FRONTEND DEVELOPMENT" },
    { id: "sinchat", title: "Sinchat", thumbnail: Sinchat, description:
  ...
  link: "/works/sinchat", category: "FRONTEND DEVELOPMENT" },
    { id: "poma", title: "Poma", thumbnail: Poma, description:
   ...
   link: "/works/poma", category: "OTHER TECHNOLOGIES" },
    { id: "pantry", title: "Pantry Vision", thumbnail: Pantry, description:
    ...
    link: "/works/pantry", category: "FULL STACK DEVELOPMENT" },
    { id: "allcentury", title: "All Century Voting", thumbnail: AllCenturry, description:
    ...
    link: "/works/allcentury", category: "FULL STACK DEVELOPMENT" },
    { id: "orientation", title: "Orientation Map", thumbnail: OrientationMap,  description:
  ...
  link: "/works/orientation", category: "FRONTEND DEVELOPMENT" },
    { id: "cs200", title: "CS200", thumbnail: CS200, description: "Digital Privacy Explorer is an interactive web-based project designed to educate users about the concept of digital fingerprints. The project introduces users to the concept of a 'digital fingerprint,' how it is created, how it is used for tracking, privacy laws and which data is being collected during account creation.",
      link: "/works/cs200" , category: "FRONTEND DEVELOPMENT" },
    { id: "wheeloflife", category: "FULL STACK DEVELOPMENT", title: "Wheel of Life App", thumbnail: WheelOfLife, description: "A mindfulness and self-improvement app that allows users to assess and track their progress in different life areas through an interactive chart.", link: "/works/wheeloflife" },
    { id: "schoolflow", category: "FRONTEND DEVELOPMENT", title: "School Flow", thumbnail: SchoolFlow, description: "A high school management software that streamlines administrative and academic workflows.", link: "/works/schoolflow" },
    { id: "neybank", category: "FULL STACK DEVELOPMENT", title: "Ney Bank", thumbnail: NeyBank, description: "A fintech app for managing different savings and checking accounts, investment portfolios, and allowing money transfers between accounts at different banks.", link: "/works/neybank" },
  ];
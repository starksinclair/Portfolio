  ...
  return (
    <>
      <div className="resume-container" id={id}>
        ...
        <p>A professional memo drafted in ENG 231 addressing the elimination of casual Friday at a company. This document demonstrates proper memo formatting and effective communication of unfavorable news while maintaining professional tone and company relationships.</p>
